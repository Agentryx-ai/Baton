# Work-Centric Orchestration Design V3
...
Supersedes: `WORK_CENTRIC_ORCHESTRATION_DESIGN_V2.md`
...
scope fence generation. A Run-wide policy or objective steer advances `run_policy_epoch`; scoped
