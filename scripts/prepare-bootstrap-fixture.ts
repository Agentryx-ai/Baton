...
const baseUrl = `http://127.0.0.1:${required('BATON_PORT')}`
...
const mutations: RecoveryMutation[] = [
  {
    ...
    endpoint: `${baseUrl}/baton/inference/anthropic`, beforeExisted: false, beforeContent: '',
    appliedContent: `{\n  "env": {\n    "ANTHROPIC_BASE_URL": "${baseUrl}/baton/inference/anthropic"\n  }\n}\n`,
  },
  {
    ...
    endpoint: `${baseUrl}/baton/inference/anthropic`, beforeExisted: false, beforeContent: '',
    appliedContent: `{\n  "inferenceProvider": "gateway",\n  "inferenceCredentialKind": "static",\n  "inferenceGatewayBaseUrl": "${baseUrl}/baton/inference/anthropic",\n  "inferenceGatewayApiKey": "fixture-secret",\n  "inferenceModels": []\n}\n`,
  },
  {
    target: 'codex', label: 'Codex CLI/Desktop', filePath: codex, format: 'toml',
    ownedFields: [['openai_base_url'], ['model_providers', 'baton']],
    endpoint: `${baseUrl}/baton/inference/openai/v1`, beforeExisted: false, beforeContent: '',
    appliedContent: `openai_base_url = "${baseUrl}/baton/inference/openai/v1"\n\n[model_providers.baton]\nname = "Baton Native (resume compatibility)"\nbase_url = "${baseUrl}/baton/inference/openai/v1"\nwire_api = "responses"\nrequest_max_retries = 0\nstream_max_retries = 0\n`,
  },
]
